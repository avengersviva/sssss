...
firewall-cmd --reload"
    ...
    if [ -z "${TAG}" ]; then
        TAG="597de5ee5e3a7ee043499c8c17ad6e70"
...
do_print_links() {
    ...
    BASE64_URL_PREFIX="https://t.me/proxy?server=${IP}&port=${PORT}&secret="
    ...
    info "Secret: ${SECRET}"
    info "Proxy links:
Normal:          ${BASE64_URL_PREFIX}${SECRET}
